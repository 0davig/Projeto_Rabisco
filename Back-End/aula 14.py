...
def pagina_nao_encontrada(erro):
    return jsonify({'erro':'Pagina não encontrada'}), 404

#ERRO 405
@app.errorhandler(405)
def metodo_invalido(erro):
    return jsonify({'erro':'Metodo HTTP invalido'}), 405
